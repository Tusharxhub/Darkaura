export const DATA = {
  ...
  contact: {
    ...
    location: {
  // OpenStreetMap embed (requested). bbox defines the viewport; layer=mapnik is default style.
  mapSrc: "https://www.openstreetmap.org/export/embed.html?bbox=88.45001578330995%2C22.735280424703028%2C88.46005797386171%2C22.741682474773338&layer=mapnik",
  largerMapUrl: "https://www.openstreetmap.org/?#map=17/22.738481/88.455037",
  ...
  footer: {
    ...
    socialLinks: [
      ...
      { platform: "GitHub", url: "https://github.com/Tusharxhub", icon: "mdi:github" },
      {
        platform: "LinkedIn",
        url: "https://www.linkedin.com/in/tushar-kanti-dey-86185b28b/",
        icon: "mdi:linkedin",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/tushardevx01/",
        icon: "mdi:instagram",
      },
    ],
